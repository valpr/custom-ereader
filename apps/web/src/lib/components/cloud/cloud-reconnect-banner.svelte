...
<div
  ...
  class="relative mx-auto mt-2 flex w-full max-w-3xl flex-wrap items-center justify-between gap-2 rounded-lg border border-[var(--astryx-color-border-subtle,#e4e4e7)] bg-[var(--astryx-color-warning-subtle,rgba(245,158,11,0.12))] px-3 py-2 text-sm text-[var(--astryx-color-fg-primary,#18181b)]"
>
