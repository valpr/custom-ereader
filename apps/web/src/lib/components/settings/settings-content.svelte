<script lang="ts">
  ...
  let visitedTabs = new Set([activeSettings || 'Reader']);
  $: if (activeSettings && !visitedTabs.has(activeSettings)) {
    visitedTabs.add(activeSettings);
