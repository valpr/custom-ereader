  ...
  <div class="showcase-container" data-astryx-theme={currentTheme}>
    ...
    <main class="showcase-grid">
      ...
      <Card padding="lg" radius="lg">
        ...
        <p class="section-desc">
          Cohesive navigation tabs and card-grouped settings lists with stacked layouts and
    ...
    >
      <div class="dialog-content-stack">
        <p>
          Astryx surface dialogs feature backdrop blur, smooth scale-in animations, accessible
          Escape key dismissal, and clear action hierarchies.
        </p>
